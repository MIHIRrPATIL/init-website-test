...
const ScrollVelocity = React.forwardRef(
  ({ children, velocity = 5, movable = true, clamp = true, className, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "relative w-full flex flex-nowrap overflow-hidden whitespace-nowrap leading-[0.8] tracking-[-2px]",
          className
        )}
        {...props}>
        <motion.div
